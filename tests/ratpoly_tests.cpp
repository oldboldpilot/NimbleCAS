    ...
    return TestSuite("nimblecas.ratpoly")
        ...
        .test("division_with_remainder",
              [](TestContext& t) {
                  ...
                  auto const dm = ipoly({-1, 0, 1}).divide(ipoly({-1, 1})).value();
                  ...
                  auto const dm2 = ipoly({1, 0, 1}).divide(ipoly({0, 2})).value();
                  ...
                  auto const d = a.divide(b).value();
                  auto const qb = d.quotient.multiply(b).value();
                  auto const recon = qb.add(d.remainder).value();
