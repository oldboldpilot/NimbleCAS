    ...
    return TestSuite("nimblecas.solve")
        .test("quadratic_irrational_radicals",
              [](TestContext& t) {
                  ...
                  const auto roots = solve_poly(ipoly({-2, 0, 1})).value();
        ...
        .test("quadratic_imaginary_radical",
              [](TestContext& t) {
                  ...
                  const auto roots = solve_poly(ipoly({1, 0, 1})).value();
                  t.expect(roots.size() == 2, "two roots");
        ...
        .test("linear_rational_root",
              [](TestContext& t) {
                  ...
                  const auto roots = solve_poly(ipoly({-1, 2})).value();
        ...
        .test("cubic_rational_plus_quadratic",
              [](TestContext& t) {
                  ...
                  const auto roots = solve_poly(p).value();
