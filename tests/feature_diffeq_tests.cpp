    ...
    return TestSuite("feature.diffeq")
        ...
        .test("ode_y_prime_equals_y_is_exp_coefficient_is_reciprocal_factorial",
              [](TestContext& t) {
                  ...
                  const SystemOperator id = [](const SeriesVec& u) -> Result<SeriesVec> {
        ...
        .test("ode_second_order_harmonic_gives_sin_and_cos",
              [](TestContext& t) {
                  ...
                  constexpr std::size_t order = 9;
                  const HigherOrderOperator f = [](const SeriesVec& y) -> Result<PowerSeries> {
        ...
        .test("ode_linear_systems_rotation_and_hyperbolic_closed_forms",
              [](TestContext& t) {
                  ...
                  const SystemOperator rot = [](const SeriesVec& u) -> Result<SeriesVec> {
                  ...
                  const SystemOperator hyp = [](const SeriesVec& u) -> Result<SeriesVec> {
        ...
        .test("ode_exp_series_agrees_with_perturbation_and_raw_powerseries",
              [](TestContext& t) {
                  ...
                  const SystemOperator id_sys = [](const SeriesVec& u) -> Result<SeriesVec> {
                      return SeriesVec{u[0]};
                  };
                  const SeriesOperator id_scalar = [](const PowerSeries& u) -> Result<PowerSeries> {
                      return u;
                  };
        ...
        .test("dde_y_prime_equals_delayed_y_matches_piecewise_polynomials",
              [](TestContext& t) {
                  ...
                  const auto history = PowerSeries::constant(Rational::from_int(1), order).value();
        ...
        .test("dae_index1_semiexplicit_exact_solution_and_ode_reduction",
              [](TestContext& t) {
                  ...
                  if (sol) {
                      ...
                      const SystemOperator twice = [](const SeriesVec& u) -> Result<SeriesVec> {
        ...
        .test("perturbation_adm_hpm_ham_agree_on_nonlinear_riccati",
              [](TestContext& t) {
                  ...
                  constexpr std::size_t order = 8;
                  const SeriesOperator sq = [](const PowerSeries& u) -> Result<PowerSeries> {
                      return u.multiply(u);
                  };
                  ...
                  if (adm) {
                      const std::vector<Rational> ones(order, Rational::from_int(1));
        ...
        .test("perturbation_exp_series_and_ham_equivalence",
              [](TestContext& t) {
                  ...
                  constexpr std::size_t order = 8;
                  const SeriesOperator id = [](const PowerSeries& u) -> Result<PowerSeries> {
                      return u;
                  };
        ...
        .test("sde_paths_are_bit_reproducible_and_ito_schemes_coincide_without_noise",
              [](TestContext& t) {
                  ...
                  const auto b = [](double x) { return 0.3 * x; };
                  const auto bp = [](double) { return 0.3; };
                  ...
                  const auto zero_b = [](double) { return 0.0; };
        ...
        .test("sde_legacy_bool_driver_equals_scheme_driver_bit_for_bit",
              [](TestContext& t) {
                  ...
                  const auto bp = [](double) { return 0.25; };
                  const double x0 = 1.0;
                  const double T = 1.0;
