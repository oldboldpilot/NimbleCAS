    ...
    return TestSuite("nimblecas.search")
        ...
        .test("ida_star_cost_equals_a_star_cost_on_weighted_grid",
              [](TestContext& t) -> void {
                  ...
                  auto heuristic = [](std::int64_t u) -> std::int64_t {
                      const std::int64_t r = u / 3;
                      const std::int64_t c = u % 3;
                      return (2 - r) + (2 - c);
                  };
                  auto goal = [](std::int64_t u) -> bool { return u == 8; };
        ...
        .test("ida_star_cost_equals_a_star_cost_on_dag_with_multiple_paths",
              [](TestContext& t) -> void {
                  ...
                  auto heuristic = [](std::int64_t) -> std::int64_t { return 0; };
                  auto goal = [](std::int64_t u) -> bool { return u == 5; };
        ...
        .test("bidirectional_dijkstra_finds_optimal_path_when_first_meeting_is_suboptimal",
              [](TestContext& t) -> void {
                  ...
                  auto predecessors = [](std::int64_t v) -> std::vector<std::int64_t> {
                      switch (v) {
                          case 1: return {0};
                          case 2: return {1};
                          case 3: return {0};
        ...
        .test("bidirectional_dijkstra_cost_matches_dijkstra_on_line_graph",
              [](TestContext& t) -> void {
                  ...
                  auto goal = [](std::int64_t u) -> bool { return u == 4; };
        ...
        .test("zero_heuristic_makes_all_a_star_variants_agree_with_dijkstra",
              [](TestContext& t) -> void {
                  ...
                  auto zero_h = [](std::int64_t) -> std::int64_t { return 0; };
                  auto goal = [](std::int64_t u) -> bool { return u == 8; };
        ...
        .test("start_satisfying_goal_returns_single_node_path_with_cost_zero",
              [](TestContext& t) -> void {
                  using namespace nimblecas;
                  auto successors = [](std::int64_t) -> std::vector<std::int64_t> { return {}; };
                  auto predecessors = [](std::int64_t) -> std::vector<std::int64_t> { return {}; };
                  auto cost = [](std::int64_t, std::int64_t) -> std::int64_t { return 1; };
                  auto heuristic = [](std::int64_t) -> std::int64_t { return 0; };
                  auto goal_at_start = [](std::int64_t u) -> bool { return u == 42; };
        ...
        .test("ida_star_returns_undefined_value_when_goal_is_unreachable",
              [](TestContext& t) -> void {
                  ...
                  auto cost = [](std::int64_t, std::int64_t) -> std::int64_t { return 1; };
                  auto heuristic = [](std::int64_t) -> std::int64_t { return 0; };
                  auto unreachable_goal = [](std::int64_t u) -> bool { return u == 99; };
        ...
        .test("negative_edge_cost_returns_domain_error_for_all_cost_algorithms",
              [](TestContext& t) -> void {
                  ...
                  auto negative_cost = [](std::int64_t, std::int64_t) -> std::int64_t { return -5; };
                  auto heuristic = [](std::int64_t) -> std::int64_t { return 0; };
                  auto goal = [](std::int64_t u) -> bool { return u == 1; };
        ...
        .test("negative_heuristic_returns_domain_error_for_all_heuristic_algorithms",
              [](TestContext& t) -> void {
                  ...
                  auto cost = [](std::int64_t, std::int64_t) -> std::int64_t { return 1; };
                  auto neg_heuristic = [](std::int64_t) -> std::int64_t { return -1; };
                  auto goal = [](std::int64_t u) -> bool { return u == 1; };
        ...
        .test("ida_star_exhausting_max_iterations_returns_not_converged",
              [](TestContext& t) -> void {
                  ...
                  auto cost = [](std::int64_t, std::int64_t) -> std::int64_t { return 10; };
                  auto heuristic = [](std::int64_t) -> std::int64_t { return 0; };
        ...
        .test("greedy_best_first_exhausting_max_expansions_returns_not_converged",
              [](TestContext& t) -> void {
                  ...
                  auto heuristic = [](std::int64_t u) -> std::int64_t { return 10 - u; };
                  auto goal = [](std::int64_t u) -> bool { return u == 4; };
        ...
        .test("parallel_neighbourhood_scan_returns_ordered_evaluations",
              [](TestContext& t) -> void {
                  ...
                  auto neighbors = [](const TabuState&) -> std::vector<TabuState> {
        ...
        .test("parallel_neighbourhood_scan_empty_neighbours_returns_empty",
              [](TestContext& t) -> void {
                  ...
                  auto empty_neighbors = [](const TabuState&) -> std::vector<TabuState> { return {}; };
                  auto objective = [](const TabuState&) -> std::int64_t { return 42; };
        ...
        .test("parallel_multistart_tabu_guards_domain_errors",
              [](TestContext& t) -> void {
                  using namespace nimblecas;
                  auto neighbors = [](const TabuState&) -> std::vector<TabuState> { return {}; };
                  auto objective = [](const TabuState&) -> std::int64_t { return 0; };
        ...
        .test("ida_star_matches_a_star_on_grid_with_obstacles",
              [](TestContext& t) -> void {
                  ...
                  auto goal = [](std::int64_t u) -> bool { return u == 15; };
