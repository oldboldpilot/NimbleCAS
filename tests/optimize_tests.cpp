    ...
    return TestSuite("nimblecas.optimize")
        ...
        .test("nelder_mead_bowl_no_gradient",
              [&](TestContext& t) {
                  ...
                  const auto bowl = [](std::span<const double> v) -> double {
        ...
        .test("parallel_multistart_matches_serial_best",
              [&](TestContext& t) {
                  ...
                  const auto local = opt::make_local_optimizer(opt::Method::bfgs, multiwell_f,
                                                         multiwell_grad);
        ...
        .test("multistart_tie_break_lowest_start_index",
              [&](TestContext& t) {
                  ...
                  const opt::LocalOptimizer square_opt =
        ...
        .test("golden_section_parabola",
              [&](TestContext& t) {
                  ...
                  const auto f = [](double x) -> double { return (x - 2.0) * (x - 2.0); };
        ...
        .test("univariate_minimizers_quartic",
              [&](TestContext& t) {
                  ...
                  const auto quartic = [](double x) -> double {
