    ...
    return TestSuite("nimblecas.dynamics")
        ...
        .test("asymptotically_stable_diagonal_negative",
              [](TestContext& t) {
                  ...
                  const auto s = is_asymptotically_stable(mat({{-1, 0}, {0, -2}}));
        ...
        .test("asymptotically_stable_diagonal_positive",
              [](TestContext& t) {
                  ...
                  const auto s = is_asymptotically_stable(mat({{1, 0}, {0, 1}}));
                  t.expect(s.has_value(), "Routh array builds");
        ...
        .test("asymptotically_stable_rotation_imaginary",
              [](TestContext& t) {
                  ...
                  const auto s = is_asymptotically_stable(mat({{0, -1}, {1, 0}}));
        ...
        .test("asymptotically_stable_defective_negative",
              [](TestContext& t) {
                  ...
                  const auto s = is_asymptotically_stable(mat({{-1, 1}, {0, -1}}));
                  t.expect(s.has_value(), "Routh array builds");
        ...
        .test("classify_stable_node",
              [](TestContext& t) {
                  const auto c = classify_equilibrium(mat({{-1, 0}, {0, -2}}));
        ...
        .test("classify_zero_with_positive_is_unstable",
              [](TestContext& t) {
                  ...
                  const auto c = classify_equilibrium(mat({{0, 0}, {0, 1}}));
                  t.expect(c.has_value(), "classify succeeds");
        ...
        .test("classify_non_rational_fallback",
              [](TestContext& t) {
                  ...
                  const auto c = classify_equilibrium(mat({{0, -1}, {1, 0}}));
                  t.expect(c.has_value(), "classify succeeds");
