    ...
    return TestSuite("nimblecas.latex")
        ...
        .test("sum",
              [](TestContext& t) {
                  ...
                  const auto neg_term = Expr::product({Expr::integer(-3), y});
        ...
        .test("product",
              [](TestContext& t) {
                  ...
                  // x y^{-1}  ->  \frac{x}{y}
                  const auto x_over_y = Expr::product({x, Expr::power(y, Expr::integer(-1))});
        ...
        .test("parenthesisation",
              [](TestContext& t) {
                  ...
                  const auto x_plus_1 = Expr::sum({x, Expr::integer(1)});
                  ...
                  const auto xy = Expr::product({x, y});
        ...
        .test("nested_expression",
              [](TestContext& t) {
                  ...
                  const auto term1 = Expr::apply("sin", {Expr::power(x, Expr::integer(2))});
                  const auto term2 = Expr::product({Expr::integer(2), x});
