    ...
    return TestSuite("nimblecas.analysis")
        ...
        .test("root_test_geometric_third",
              [](TestContext& t) {
                  ...
                  const auto rr3 = root_test([](std::int64_t n) {
        ...
        .test("alternating_harmonic_leibniz",
              [](TestContext& t) {
                  ...
                  const auto v = alternating_series_test(
        ...
        .test("raabe_p2_series_converges_numeric",
              [](TestContext& t) {
                  ...
                  const auto r = raabe_test([](std::int64_t n) { return rr(1, n * n); });
        ...
        .test("gauss_resolves_harmonic_boundary",
              [](TestContext& t) {
                  ...
                  const auto g2 = gauss_test([](std::int64_t n) { return rr(1, n * (n + 1)); });
        ...
        .test("dirichlet_bounded_partial_sums",
              [](TestContext& t) {
                  ...
                  const auto v2 = dirichlet_test([](std::int64_t) { return 1.0; },
                                           [](std::int64_t n) { return 1.0 / static_cast<double>(n); });
        ...
        .test("lyapunov_solve_reconstructs_stable",
              [](TestContext& t) {
                  ...
                  if (p) {
                      ...
                      const auto pd = is_positive_definite(*p);
        ...
        .test("is_positive_definite_sylvester",
              [](TestContext& t) {
                  ...
                  const auto pd = is_positive_definite(mat({{2, 1}, {1, 2}}));
        ...
        .test("stable_A_is_positive_definite_and_agrees",
              [](TestContext& t) {
                  ...
                  const Matrix a = mat({{-1, 1}, {0, -1}});
                  const auto stable = is_stable_lyapunov(a);
                  t.expect(stable.value_or(false), "Lyapunov/Sylvester: A is stable");
                  const auto rh = is_asymptotically_stable(a);
